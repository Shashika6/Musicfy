          ...
          <div class="container">    
                  <div class="row">
                      <div class="panel panel-default">
                          <div class="panel-heading"><center>  <h4 >My Account</h4></center></div>
                ...
                $temp = explode(".", $posttype );
                 ...
                 $ext = end($temp);
                  ...
                  if ( in_array($ext, $imgformats) ){
                       $replace = '<img src= "' . $link . '"  id="profile-image1" class="img-circle img-responsive">';
                      $image=true;
                  } else {
                        $replace = '<img src= "https://cdn4.iconfinder.com/data/icons/evil-icons-user-interface/64/avatar-512.png"  id="profile-image1" class="img-circle img-responsive">';
                        $image=false;
                  }
        ...
        echo $replace;
          ...
          ?>
           ...
           foreach($genreNames as $genre){
                           echo"<li><p>".$genre."</p></li>";
           }
                           ?>
                          </ul>
                          <hr>
                          <?php
                         echo"<div class='col-sm-5 col-xs-6 tital'>".$email."</div>"
                          ?>
                      </div>
                </div>
            </div>
          ...
          <div class="row">
	<div class="wrapper">
            <div class="example-2"><b> <a href ="/CourseWork/index.php/MyAccount/showFriendList?" style="color:white;">Friends</a></b></div>
            <div class="example-2"><b><a href ="/CourseWork/index.php/MyAccount/showFollowList?" style="color:white;">Following</a></b></div>
            <div class="example-2"><b> <a href ="/CourseWork/index.php/MyAccount/showFolloweeList?" style="color:white;">Followers</a></b></div>
